...
<section class="top-container">
    ...
    <div class="top-container-right">
        <?php if (current_user_can('edit_posts')) : ?>
            <div class="tc-edit" data-icon="camera"
                 @click="$nextTick(() => { window.dispatchEvent(new CustomEvent('write-modal-open')) })">
                <?php get_template_part('components/svgs/camera'); ?>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<div class="preloaded-icons" style="display: none;">
    ...
    <div data-icon="camera"><?php get_template_part('components/svgs/camera'); ?></div>
    ...
    <div data-icon="camera-outline"><?php get_template_part('components/svgs/camera-outline'); ?></div>
