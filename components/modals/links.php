<div class="links-modal" x-cloak
     x-data="{
         ...
         async loadLinks() {
             ...
             this.error = null;
             try {
                 const response = await fetch(window.TIMELLOW_CONFIG.actionUrl + '?do=getFriendLinks');
                    ...
                    <template x-for="link in links" :key="link.id">
                        <a :href="link.url" target="_blank" rel="noopener noreferrer" class="link-item">
                            <div class="link-avatar">
                                <img :src="link.avatar || window.TIMELLOW_CONFIG.defaultAvatar"
                                     :alt="link.name"
                                     loading="lazy"
                                     onerror="this.src=window.TIMELLOW_CONFIG.defaultAvatar">
                            </div>
                            <div class="link-info">
